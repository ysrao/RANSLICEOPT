...
adaptive deterministic gNB rule, DQN, and PPO under an identical
...
The PPO and DQN paths use the same disclosed gNB capacity/recovery action mask,
so their displayed names omit the shared qualifier.
